...
* [STKO (Scientific ToolKit for OpenSees)](https://asdeasoft.net/stko/) - A extended version of [MPC](https://asdeasoft.net/preandpostprocessor/) (Multi Purpose CAE) specialized to interact with OpenSees. (Windows only)
